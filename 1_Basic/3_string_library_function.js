...
var c = "Bangladesh";
var n = " is a beautifull country";
let cn = c+n;
cn = cn.toUpperCase();// convert to uppercase
console.log(cn);
cn = cn.toLowerCase()
console.log(cn)
// string concatination:
console.log("Today is thursday"+" and it is bengali new year!")
var a = "hello";
var b = " im 20 years old";
var x = a.concat(b);
console.log(x)


// Length count: output = 10
var newData = "Bangladesh";
var newData = newData.length;
console.log(newData)

// index number:
var txt = "hello";
newData = txt.charAt(2);//print index number 
// output should = l
console.log(newData)

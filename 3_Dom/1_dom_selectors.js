...
var para =document.getElementsByClassName("class");

var para =document.querySelector("#id/.class/tagName/div p");
var para =document.querySelectorAll("p[0]");// select paragraph tag which are in 0 index
